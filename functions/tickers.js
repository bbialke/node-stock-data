...
const formatOptions = require('../util/formatOptionsTickers');
...
async function tickers({ API_TOKEN, options }) {
  const URL = 'http://api.marketstack.com/v1/tickers';
  if (API_TOKEN === undefined) {
    throw new Error(
      'No API_TOKEN provided, add your API_TOKEN from http://marketstack.com/ as an argument'
    );
  }
